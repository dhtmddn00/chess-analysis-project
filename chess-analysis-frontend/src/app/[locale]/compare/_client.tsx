        ...
        {(p1.result || p2.result) && (
          <div className="bg-white rounded-xl border border-zinc-200 p-5 shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-2 pb-2 border-b border-zinc-200 mb-1">
              <div className="text-xs font-black text-zinc-900 text-right truncate">{p1.result?.username ?? t('player1')}</div>
              <div className="text-xs text-zinc-400 text-center">{t('metricsLabel')}</div>
              <div className="text-xs font-black text-zinc-900 text-left truncate">{p2.result?.username ?? t('player2')}</div>
            </div>
            <StatRow
              label={t('accuracy')}
